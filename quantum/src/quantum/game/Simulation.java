...
public strictfp class Simulation {
	...
	public void calculatePaths () {
		...
		try {
			...
			Gdx.app.log("[Simulation]", "couldn't triangulate planets: ", ex);
			ex.printStackTrace();
		}
	}
...
//			for (int i = 0; i < delaunay.Tri.length; i++) {
//				int tri[] = delaunay.Tri[i];
//				Vector2 p1 = planets.get(tri[0]).getPosition();
//				Vector2 p2 = planets.get(tri[1]).getPosition();
//				Vector2 p3 = planets.get(tri[2]).getPosition();
//
