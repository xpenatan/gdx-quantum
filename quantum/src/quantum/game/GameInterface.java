...
public strictfp class GameInterface  {
//	Simulation sim;
//	OrthoCamera cam;
...
//			else
//				GL11.glColor4f(0.7f, 0.7f, 0.7f, 0);
...
//	}
//
	public GameInterface (GameLoop loop, Simulation sim, Renderer renderer) {
//		this.canvas = canvas;
//		this.sim = sim;
...
//	}
//
//	private void renderTreeButton (Planet planet) {
//		if (planet == null) return;
//
//		if (is_replay) return;
//
//		tmp.set(1, 1).nor().scl(selected_planet.getRadius() * 1.2f);
//
...
//				GL11.glVertex2f(p_x, p_y);
//				GL11.glVertex2f(a_x, a_y);
//				GL11.glVertex2f(a_x, a_y);
//				GL11.glVertex2f(a_x + 20, a_y);
//				GL11.glEnd();
//
//				a_x += 25;
//				a_y -= font.getHeight();
...
//				tmp.set(-1, 1).nor().scl(planet.getRadius() * 1.4f);
...
//				GL11.glVertex2f(a_x, a_y);
//				GL11.glTexCoord2f(1, 0);
//				GL11.glVertex2f(a_x - 16, a_y);
//				GL11.glTexCoord2f(1, 1);
//				GL11.glVertex2f(a_x - 16, a_y - 16);
//				GL11.glTexCoord2f(0, 1);
//				GL11.glVertex2f(a_x, a_y - 16);
//				GL11.glEnd();
//				mark.unbind();
//			}
//		}
...
//		else
//			GL11.glColor4f(1, 216f / 255f, 0, 0.7f);
//// gl.glLineWidth( 1 );
//		GL11.glBegin(GL.GL_LINES);
//		for (int i = 0; i < 5; i++) {
//			GL11.glVertex2f(x + tmp2.x * WIDTH, y + tmp2.y * WIDTH);
//			GL11.glVertex2f(x - tmp2.y * WIDTH, y + tmp2.x * WIDTH);
//			GL11.glVertex2f(x + tmp2.x * WIDTH, y + tmp2.y * WIDTH);
//			GL11.glVertex2f(x + tmp2.y * WIDTH, y - tmp2.x * WIDTH);
//			x += tmp2.x * 4;
//			y += tmp2.y * 4;
...
//		GL11.glPolygonMode(GL.GL_FRONT_AND_BACK, GL2.GL_FILL);
...
//	}
//
//	private void renderHoverPlanetStats () {
//		if (hover_timer.getElapsedSeconds() < delay) return;
//
//		float x = cam.getScreenToWorldX(Gdx.input.getX());
//		float y = cam.getScreenToWorldY(Gdx.input.getY());
//
...
//			if (col != null) GL11.glColor3f(col.r, col.g, col.b);
//
//			font.renderText(42, y, clients.getNames().get(i));
//
//			if (max_score != 0) {
//				GL11.glBegin(GL11.GL_LINES);
//				GL11.glVertex2f(42 + max_width, y - font.getHeight() / 2 - 3);
//				GL11.glVertex2f(42 + max_width + score / max_score * 50, y - font.getHeight() / 2 - 3);
//				GL11.glEnd();
//			}
//
...
//	}
//
//	private void renderPlanetStats (Planet selected_planet) {
...
//		GL11.glVertex2f(a_x + max_width, a_y - font.getHeight() / 2 - 3);
//		GL11.glVertex2f(a_x + max_width + 50, a_y - font.getHeight() / 2 - 3);
//
//		GL11.glColor3f(1, 1, 1);
//		GL11.glVertex2f(a_x + max_width, a_y - font.getHeight() / 2 - 3);
//		GL11.glVertex2f(a_x + max_width + 50 * selected_planet.getStrength(), a_y - font.getHeight() / 2 - 3);
//
//		GL11.glColor3f(0.2f, 0.2f, 0.2f);
//		GL11.glVertex2f(a_x + max_width, a_y - font.getHeight() / 2 - font.getHeight() - 3);
//		GL11.glVertex2f(a_x + max_width + 50, a_y - font.getHeight() / 2 - font.getHeight() - 3);
//
//		GL11.glColor3f(1, 1, 1);
//		GL11.glVertex2f(a_x + max_width, a_y - font.getHeight() / 2 - font.getHeight() - 3);
//		GL11.glVertex2f(a_x + max_width + 50 * selected_planet.getHealth(), a_y - font.getHeight() / 2 - font.getHeight() - 3);
//
//		GL11.glColor3f(0.2f, 0.2f, 0.2f);
//		GL11.glVertex2f(a_x + max_width, a_y - font.getHeight() / 2 - font.getHeight() * 2 - 3);
//		gl.glVertex2f(a_x + max_width + 50, a_y - font.getHeight() / 2 - font.getHeight() * 2 - 3);
//
//		GL11.glColor3f(1, 1, 1);
//		GL11.glVertex2f(a_x + max_width, a_y - font.getHeight() / 2 - font.getHeight() * 2 - 3);
//		GL11.glVertex2f(a_x + max_width + 50 * selected_planet.getSpeed(), a_y - font.getHeight() / 2 - font.getHeight() * 2 - 3);
//
//		GL11.glEnd();
//		GL11.glLineWidth(1.5f);
//	}
